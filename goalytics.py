...
API_KEY =API_KEY = st.secrets.auth.hf['HF_API_KEY']
...
#Copie pour relations entre tables
...
cotes_du_jour2[['Equipe Domicile','Equipe Extérieure']]=cotes_du_jour2[['Equipe Domicile','Equipe Extérieure']].replace("Majorque","Mallorca")
cotes_du_jour2[['Equipe Domicile','Equipe Extérieure']]=cotes_du_jour2[['Equipe Domicile','Equipe Extérieure']].replace("FC Séville","Sevilla")
cotes_du_jour2[['Equipe Domicile','Equipe Extérieure']]=cotes_du_jour2[['Equipe Domicile','Equipe Extérieure']].replace("Gérone","Girona")
cotes_du_jour2[['Equipe Domicile','Equipe Extérieure']]=cotes_du_jour2[['Equipe Domicile','Equipe Extérieure']].replace("CF Valence","Valencia")
cotes_du_jour2[['Equipe Domicile','Equipe Extérieure']]=cotes_du_jour2[['Equipe Domicile','Equipe Extérieure']].replace("CD Leganes","Leganes")
cotes_du_jour2[['Equipe Domicile','Equipe Extérieure']]=cotes_du_jour2[['Equipe Domicile','Equipe Extérieure']].replace("Paris SG","PSG")
cotes_du_jour2[['Equipe Domicile','Equipe Extérieure']]=cotes_du_jour2[['Equipe Domicile','Equipe Extérieure']].replace("Inter Milan","Inter")
cotes_du_jour2[['Equipe Domicile','Equipe Extérieure']]=cotes_du_jour2[['Equipe Domicile','Equipe Extérieure']].replace("Naples","Napoli")
cotes_du_jour2[['Equipe Domicile','Equipe Extérieure']]=cotes_du_jour2[['Equipe Domicile','Equipe Extérieure']].replace("Bologne","Bologna")
cotes_du_jour2[['Equipe Domicile','Equipe Extérieure']]=cotes_du_jour2[['Equipe Domicile','Equipe Extérieure']].replace("Juventus Turin","Juventus")
cotes_du_jour2[['Equipe Domicile','Equipe Extérieure']]=cotes_du_jour2[['Equipe Domicile','Equipe Extérieure']].replace("AS Rome","AS Roma")
cotes_du_jour2[['Equipe Domicile','Equipe Extérieure']]=cotes_du_jour2[['Equipe Domicile','Equipe Extérieure']].replace("FC Séville","Sevilla")
cotes_du_jour2[['Equipe Domicile','Equipe Extérieure']]=cotes_du_jour2[['Equipe Domicile','Equipe Extérieure']].replace("Lazio Rome","Lazio")
cotes_du_jour2[['Equipe Domicile','Equipe Extérieure']]=cotes_du_jour2[['Equipe Domicile','Equipe Extérieure']].replace("Milan AC","AC Milan")
cotes_du_jour2[['Equipe Domicile','Equipe Extérieure']]=cotes_du_jour2[['Equipe Domicile','Equipe Extérieure']].replace("Como 1907","Como")
cotes_du_jour2[['Equipe Domicile','Equipe Extérieure']]=cotes_du_jour2[['Equipe Domicile','Equipe Extérieure']].replace("Hellas Vérone","Verona")
cotes_du_jour2[['Equipe Domicile','Equipe Extérieure']]=cotes_du_jour2[['Equipe Domicile','Equipe Extérieure']].replace("Parme","Parma")
cotes_du_jour2[['Equipe Domicile','Equipe Extérieure']]=cotes_du_jour2[['Equipe Domicile','Equipe Extérieure']].replace("Venezia FC","Venezia")
cotes_du_jour2[['Equipe Domicile','Equipe Extérieure']]=cotes_du_jour2[['Equipe Domicile','Equipe Extérieure']].replace("AC Monza","Monza")
cotes_du_jour2[['Equipe Domicile','Equipe Extérieure']]=cotes_du_jour2[['Equipe Domicile','Equipe Extérieure']].replace("Nottingham F.","Nottingham")
cotes_du_jour2[['Equipe Domicile','Equipe Extérieure']]=cotes_du_jour2[['Equipe Domicile','Equipe Extérieure']].replace("Man. City","Manchester City")
cotes_du_jour2[['Equipe Domicile','Equipe Extérieure']]=cotes_du_jour2[['Equipe Domicile','Equipe Extérieure']].replace("Brighton Hove","Brighton")
cotes_du_jour2[['Equipe Domicile','Equipe Extérieure']]=cotes_du_jour2[['Equipe Domicile','Equipe Extérieure']].replace("Man. United","Manchester Utd")
cotes_du_jour2[['Equipe Domicile','Equipe Extérieure']]=cotes_du_jour2[['Equipe Domicile','Equipe Extérieure']].replace("Wolverhampton","Wolves")
